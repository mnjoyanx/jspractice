...
var modals = function modals() {
  function bindModal(trigger, modal, close) {
    ...
    modalSelector.addEventListener('click', function (evt) {
...
var tabs = function tabs(header, tab, content, active) {
  ...
  function hideTabContent() {
    contentSelector.forEach(function (item) {
  ...
  headerSelector.addEventListener('click', function (event) {
    ...
    if (target.classList.contains(tab.replace(/\./, '')) || target.parentNode.classList.contains(tab.replace(/\./, ''))) {
      tabSelector.forEach(function (item, idx) {
        if (target == item || target.parentNode == item) hideTabContent();
        showTabContent(idx);
      });
    }
  });
